<?php
/**
 * MobileAdminPauseController
 * 
 * Controller mobile para gerenciar pausa programada da loja
 * Usa as mesmas funcionalidades do desktop com interface mobile
 * 
...
class MobileAdminPauseController extends Controller
{
    ...
    /**
     * Garante autenticação para mobile
     */
    ...
    public function extend(array $params = []): void
    {
        ...
        if ($extraMinutes < 1 || $extraMinutes > 480) {
            $this->jsonResponse([
                'success' => false,
