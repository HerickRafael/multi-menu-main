...
RUN apt-get update && apt-get install -y \
    ...
    && docker-php-ext-install pdo pdo_mysql zip gd mbstring xml curl gmp \
    && pecl install redis \
...
# Build frontend (Tailwind CSS + JS minification)
# Requires: npm run build executed before docker build, or use multi-stage:
